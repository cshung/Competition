...
#include "LEET_BINARY_TREE_LEVEL_ORDER_TRAVERSAL.h"
...
namespace _LEET_BINARY_TREE_LEVEL_ORDER_TRAVERSAL
{
    struct TreeNode
    {
        int val;
...
using namespace _LEET_BINARY_TREE_LEVEL_ORDER_TRAVERSAL;
