...
#include "LEET_CAMPUS_BIKES_II.h"
#include <map>
#include <iostream>
#include <queue>
#include <vector>
...
namespace _LEET_CAMPUS_BIKES_II
{
    class Solution
    {
    public:
...
using namespace _LEET_CAMPUS_BIKES_II;

int LEET_CAMPUS_BIKES_II()
{
    Solution solution;
    int worker1[] = { 0, 0 };
    int worker2[] = { 2, 1 };
    ...
    workers.push_back(vector<int>(worker1, worker1 + _countof(worker1)));
    workers.push_back(vector<int>(worker2, worker2 + _countof(worker2)));
    bikes.push_back(vector<int>(bike1, bike1 + _countof(bike1)));
    bikes.push_back(vector<int>(bike2, bike2 + _countof(bike2)));
