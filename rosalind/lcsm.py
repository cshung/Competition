...
# for the answer
#
def longest_common_substring(records):
  separator = 'a'
  count = 0
  tree = suffix_tree()
  index = []
  ...
  answer = {}
  answer["max"] = -1
  longest_common_substring_find(tree, tree.get_root(), 0, index, [False] * len(records), answer)
  return (all[answer["begin"]:answer["end"]])
...
def main():
  ...
  answer = longest_common_substring(records)
  print(answer)
